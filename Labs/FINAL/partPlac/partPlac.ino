...
void loop() {
  ...
  if(debug){
    ...
    Serial.print( cameraState);
    Serial.print(", partState = ");
    Serial.print(partState);
    Serial.print(", revRelState = ");
    Serial.print(revRelState);
    Serial.print(", fluxDispState = ");
    Serial.println(fluxDispState);
  }
